...
SECRET_KEY = 'django-insecure-=_vlqi&c8m&0)o3_&-bk3n0+r0#b1qlob=q3m4%du0@lcl8ss#'
...
AUTH_PASSWORD_VALIDATORS = [
    # Comment out or remove all existing validators
    # {
...
# CORS settings if your frontend is served from a different domain/port
